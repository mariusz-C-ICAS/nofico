    ...
    <footer className="bg-white border-t border-slate-200 py-8 px-6 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col items-center md:items-start gap-2">
          ...
          <p className="text-xs text-slate-500">Wszystkie procesy firmy w jednej bezpiecznej platformie.</p>
        </div>

        <div className="flex gap-8 text-xs font-medium text-slate-600">
          <a href="#" className="hover:text-blue-600 transition-colors">Dokumentacja API</a>
          <a href="#" className="hover:text-blue-600 transition-colors">Centrum Pomocy</a>
          <a href="#" className="hover:text-blue-600 transition-colors">Polityka Prywatności</a>
          <a href="#" className="hover:text-blue-600 transition-colors">Warunki Programu</a>
        </div>
