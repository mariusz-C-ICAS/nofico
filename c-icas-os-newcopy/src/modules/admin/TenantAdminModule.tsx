           ...
           <div key={t.id} className="bg-white border border-slate-200 p-8 rounded-[2.5rem] shadow-sm hover:shadow-2xl transition-all group relative overflow-hidden">
              ...
              <div className="mt-6 pt-4 border-t border-slate-50 flex items-center justify-between">
                 <div className="flex gap-2 items-center">
                    ...
                    >
                      {t.isProduction ? 'PROD' : 'TEST'}
                    </button>
                    {t.isProduction && <span className="text-[9px] text-rose-600 font-bold">Produkcja</span>}
                    {!t.isProduction && <span className="text-[9px] text-slate-400 font-bold">Demo/Test</span>}
                 </div>
              </div>
