/**
 * Data: 2026-05-12
 * Zmiany: Edytor ofert handlowych.
          ...
          <div className="bg-white rounded-[3rem] border border-slate-100 shadow-sm p-10">
             <div className="flex justify-between items-center mb-12">
                <div>
                   ...
                   <h4 className="text-2xl font-black text-slate-900 uppercase italic tracking-tighter">OFE/2026/05/012</h4>
                </div>
                <div className="flex gap-4">
                   <button className="bg-slate-100 text-slate-400 p-4 rounded-2xl hover:bg-slate-900 hover:text-white transition-all">
                      <Download size={20} />
                   </button>
                   <button className="bg-indigo-600 text-white px-10 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-3 hover:bg-slate-900 transition-all shadow-xl shadow-indigo-100">
                      <Send size={18} /> Wyślij Ofertę
                   </button>
                </div>
             </div>
             ...
             <div className="space-y-6">
                ...
                <button className="w-full py-6 rounded-2xl border-2 border-dashed border-slate-100 text-slate-300 hover:text-indigo-600 hover:border-indigo-100 transition-all flex items-center justify-center gap-3 mt-8">
                   <Plus size={18} /> 
