...
export const generateIdesData = async (tenantId: string) => {
  ...
  try {
    // 1. Struktura Organizacyjna (OM) - Działy
    const depts = [
    ...
    // 3. Pracownicy (30 osób - pełni z danymi)
    // Generujemy 30 pacowników
    for (let i = 0; i < 30; i++) {
    ...
    // 4. Rekrutacje (5 otwartych stanowisk)
