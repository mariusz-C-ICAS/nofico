...
import { validatePESEL } from '../services/validators';
...
export function PESELInput({ value, onChange, label = 'PESEL', required, className = '' }: Props) {
  const [touched, setTouched] = useState(false);
  const result = value ? validatePESEL(value) : null;
