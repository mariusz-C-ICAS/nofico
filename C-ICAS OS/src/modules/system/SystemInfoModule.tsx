      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-3/4">
          ...
          {activeTab === 'tasks' && (
            <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-slate-100">
               <h2 className="text-xl font-black text-slate-800 uppercase tracking-tighter mb-6 flex items-center gap-2">
                <CheckCircle className="text-emerald-500" /> Moje Zadania Biznesowe
              </h2>
              <div className="text-center py-10 bg-slate-50 rounded-2xl border border-slate-100">
                 <p className="text-sm font-medium text-slate-400">Brak przypisanych zadań przypominających na dzisiaj.</p>
              </div>
            </div>
          )}
