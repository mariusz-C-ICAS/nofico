...
export const AVAILABLE_PROVIDERS: IntegrationProvider[] = [
  ...
  { id: 'calsyncpro', name: 'CalSyncPro', category: 'system', description: 'Sync Exchange/365/Outlook.com, Google Workspace/Gmail, Apple/Fastmail/Yahoo CalDAV → Booking, Kanban', authType: 'api_key', configurationType: 'dedicated', fixedApiUrl: 'https://api.calsyncpro.com/api/v1' },
