...
const TEMPLATES = [
  ...
  },
  {
    ...
    documentType: 'CUSTOM',
    description: 'Proces wdrożenia nowego pracownika — od przygotowania stanowiska do przypisania do projektu',
    steps: [
      {
        id: 'step-1',
        name: 'Przygotowanie stanowiska IT',
        type: 'TASK',
        assignToRole: 'it',
        slaHours: 48,
        order: 1,
      ...
      {
        id: 'step-2',
        name: 'Podpisanie umowy i dokumentów HR',
        type: 'APPROVAL',
        assignToRole: 'hr',
        slaHours: 24,
        order: 2,
      ...
      {
        id: 'step-3',
        name: 'Wydanie sprzętu i podpisanie protokołu',
        type: 'APPROVAL',
        assignToRole: 'it',
        slaHours: 24,
        order: 3,
      ...
      {
        id: 'step-5',
        name: 'Nadanie dostępów systemowych',
        type: 'TASK',
        assignToRole: 'it',
        slaHours: 24,
        order: 5,
      ...
      {
        id: 'step-6',
        name: 'Przypisanie do projektu i mentora',
        type: 'APPROVAL',
        assignToRole: 'manager',
        slaHours: 48,
        order: 6,
