/**
 * Data: 2026-05-12
 * Zmiany: Lista klientów z walidacją NIP.
 * Ścieżka: /src/modules/crm/components/CustomerList.tsx
 */
import React, { useEffect, useState } from 'react';
import { 
  Building2, Mail, Phone, ExternalLink, 
  ShieldCheck, AlertTriangle, MoreVertical,
       ...
       {customers.map(cust => (
         ...
         >
            <div className="flex gap-8">
               <div className="w-24 h-24 bg-slate-50 rounded-[2.5rem] flex items-center justify-center border-4 border-white shadow-xl flex-shrink-0">
               ...
               <div className="flex-1 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     ...
                     <div className="bg-slate-50 p-4 rounded-2xl flex items-center gap-3 border border-slate-100">
                        ...
                        <span className="text-[10px] font-black text-slate-700">{cust.value || '0 PLN'}</span>
                     </div>
                  </div>

                  <div className="flex gap-3 pt-4 border-t border-slate-50">
                     <button className="flex-1 bg-slate-900 text-white py-4 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-indigo-600 transition-all flex items-center justify-center gap-2">
