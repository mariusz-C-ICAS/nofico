      ...
      <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
        <div className="flex flex-wrap gap-3 items-center">
          <div className="relative">
            ...
            <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Szukaj pracownika..."
      ...
      <div className="bg-white rounded-[3rem] border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="px-8 py-5 border-t border-slate-100">
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic">
            Wyświetlono {filtered.length} z {employees.length} pracowników
          </span>
        </div>
      </div>
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }}
              ...
              <div className="space-y-4">
                {([
                  ...
                  { label: 'Stanowisko', key: 'position', placeholder: 'Developer' },
                  { label: 'Data zatrudnienia', key: 'startDate', placeholder: '2026-05-16' },
                ] as const).map(f => (
                  <div key={f.key}>
                ...
                <div>
                  <label className="block text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Dział</label>
