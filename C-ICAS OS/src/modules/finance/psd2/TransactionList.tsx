/**
 * Data: 2026-05-12
 * Zmiany: Lista transakcji bankowych z mechanizmem autoparowania.
...
import { 
  ...
  User, Link2, Sparkles, MoreVertical
} from 'lucide-react';
...
export default function TransactionList() {
  ...
  const transactions: Transaction[] = [
    { 
      id: '1', 
      date: '2026-05-12', 
      counterpart: 'T-MOBLIE POLSKA S.A.', 
      title: 'FAKTURA NR 123/2026 - ABONAMENT MAJ', 
      amount: -123.00, 
      type: 'outgoing', 
      status: 'matched',
      suggestedInvoice: 'FV/TM/2026/05'
    },
    { 
      id: '2', 
      date: '2026-05-11', 
      counterpart: 'CLIENT X SP. Z O.O.', 
      title: 'ZAPLATA ZA FV 10/2026', 
      amount: 4500.00, 
      type: 'incoming', 
      status: 'suggested',
      suggestedInvoice: 'FV/2026/10',
      matchScore: 98
    },
    { 
      id: '3', 
      date: '2026-05-10', 
      counterpart: 'STACJA PALIW ORLEN', 
      title: 'TANKOWANIE POJAZDU WZ 12345', 
      amount: -350.00, 
      type: 'outgoing', 
      status: 'unmatched'
    },
    { 
      id: '4', 
      date: '2026-05-09', 
      counterpart: 'MICROSOFT IRELAND', 
      title: 'AZURE CLOUD SERVICES MSFT-9876', 
      amount: -42.50, 
      type: 'outgoing', 
      status: 'suggested',
      suggestedInvoice: 'FV/CLOUD/2026/05',
      matchScore: 85
    }
  ];
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6">
         ...
         <div className="flex gap-4 w-full md:w-auto">
            <button className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-slate-50 text-slate-500 px-8 py-5 rounded-2xl text-[10px] font-black uppercase tracking-widest border border-slate-100 hover:bg-slate-100 transition-all">
                    ...
                    <td className="px-8 py-6">
                       <div className="flex items-center gap-4">
                          ...
                          <div>
                             ...
                             <div className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">ID: {tx.id}</div>
                          </div>
                       </div>
                    </td>
                    <td className="px-8 py-6">
